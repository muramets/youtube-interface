...
| Файл | Назначение |
|------|-----------|
| `functions/src/services/tools/handlers/analysis/analyzeTrafficSources.ts` | Handler: resolveVideosByIds → Cloud Storage → parse → timeline → JSON |
...
| Файл | Кейсов |
|------|--------|
| `functions/src/services/tools/handlers/analysis/__tests__/analyzeTrafficSources.test.ts` | — |
