...
- `functions/src/services/sync.ts` — `SyncService.syncChannel()`, `refreshSubscriberCounts()`, `sendNotification()`
...
### 1026 тестов проходят (360 frontend + 666 backend), lint + typecheck чисто.
