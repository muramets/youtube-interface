...
- [Packaging Check-ins](./packaging-checkins.md) — система напоминаний загрузки snapshot после публикации
...
| `functions/src/services/tools/handlers/detail/getMultipleVideoDetails.ts` | Обновить `formatVideoData()` — пробросить A/B данные для own-видео |
