...
| Unified DataTable (Tables unification) | DataTable infra, TrafficSourceTable + TrendsTable мигрированы, TrafficTable/Row theme fix. ~40 hardcoded цветов → theme-aware. [Task doc](../archive/tasks/ui/unified-table.md) |
