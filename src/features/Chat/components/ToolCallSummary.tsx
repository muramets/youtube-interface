...
import { Loader2, Check, AlertCircle, ChevronDown, BarChart3, TrendingUp, Images, Satellite, Globe, PieChart, Users, Telescope, Search } from 'lucide-react';
...
const FindSimilarStats: React.FC<{ result: Record<string, unknown> }> = ({ result }) => {
    ...
    return (
        <div className="flex flex-col items-start max-w-full">
            ...
            >
                ...
                ) : group.toolName === 'findSimilarVideos' && group.allResolved && !group.hasErrors ? (
            ...
            {expanded && group.allResolved && !group.hasErrors && (
                <div className="mt-1.5 flex flex-col gap-1 w-full">
                    ...
                    {group.toolName === 'findSimilarVideos' && group.records[0]?.result && (
                        <FindSimilarStats result={group.records[0].result} />
                    )}
