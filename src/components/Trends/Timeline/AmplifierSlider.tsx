...
export const AmplifierSlider: React.FC<AmplifierSliderProps> = ({ amplifierLevel, onChange }) => {
    ...
    return (
        <div className="absolute bottom-4 right-32 pointer-events-auto z-sticky flex flex-col items-end gap-2 group">
            ...
            <div className="flex items-center bg-bg-secondary/90 backdrop-blur-md border border-border rounded-full px-2 py-1 gap-2">
