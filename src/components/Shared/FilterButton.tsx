                            ...
                            <div className="py-2">
                                {filterTypes.map(({ type, label, icon: Icon }) => (
                                    <button
                                        ...
                                        className="w-full text-left px-4 py-3 text-sm font-medium flex items-center justify-between transition-colors border-none cursor-pointer text-text-primary hover:bg-[#161616] bg-transparent"
                                    >
