              ...
              video.isCloned ? (
                ...
                <>
                  <button
                    ...
                    className={`p-2 rounded-full hover:bg-black/40 dark:hover:bg-white/20 text-text-primary transition-opacity ${isMenuOpen ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
                  >
