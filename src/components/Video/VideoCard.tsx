              ...
              video.isCloned ? (
                ...
                <>
                  <button
                    ...
                    className={`p-2 rounded-full hover:bg-black/10 dark:hover:bg-white/10 text-text-primary transition-opacity ${isMenuOpen ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
                  >
