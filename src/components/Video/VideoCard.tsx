              ...
              video.isCloned ? (
                ...
                <>
                  <button
                    ...
                    className={`p-2 rounded-full hover:bg-white hover:shadow-sm dark:hover:bg-white/20 dark:hover:shadow-none text-text-primary transition-all ${isMenuOpen ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}
                  >
